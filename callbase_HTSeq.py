...
have a bam file and a vcf file which offer the SNP sites. The bam file which
is binary file of sam file. Currently, the bamfile must have been splited N
...
#the first line of the RF, position is what in vcf file,1-based
    for i in VF:
        ...
        refbase = i.refi #i.e. R
        print 'processing: %s......'%(i.chrom + '  ' + str(i.pos.pos))
